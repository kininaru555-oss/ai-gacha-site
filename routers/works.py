...
from helpers import (
    ensure_user, ensure_work, get_owned_card, get_ownership,
    serialize_work, serialize_owned_card
)
    ...
    with get_db() as conn:
        ...
        with conn.cursor() as cur:
            ...
            """, (
                ...
                payload.rarity, hp, atk, defense, spd, luk,
                int(payload.exp_reward),
                1, int(payload.is_ball), payload.ball_code,
                payload.content_hash.strip(),
            ))
